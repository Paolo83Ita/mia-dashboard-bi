...
# ==========================================================================
# 1. CONFIGURAZIONE & STILE (v40.0 - Purchase Matrix Added)
# ==========================================================================
st.set_page_config(
...
def get_ai_response(user_query):
    if not AI_AVAILABLE: return "⚠️ Modulo AI non installato."
    available_dfs = {}
    ...
    if not available_dfs: return "⚠️ Nessun dato caricato."
    ...
    try:
        if "gemini_api_key" in st.secrets:
            ...
            return local_vars.get('result', "❌ Nessun risultato.")
        else: return "🔑 Configura API Key."
...
with st.sidebar:
    ...
    if not AI_AVAILABLE:
        st.warning("⚠️ Libreria AI mancante.")
    else:
