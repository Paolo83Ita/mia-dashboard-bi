...
def convert_df_to_excel(df: pd.DataFrame) -> bytes:
 Rotated code block for better readability
    output = io.BytesIO()
...
def render_ai_assistant(context_df: pd.DataFrame = None, context_label: str = ""):
    ...
    if user_input:
        ...
        if context_df is not None and not context_df.empty:
            sample = context_df.head(500)  # Aumentato per contesto più ricco
            context_text = (
...
if page == "📊 Vendite & Fatturazione":
    ...
    if df_processed is not None:
        ...
        if not df_global.empty:
            ...
            # Grafici e drill-down (mantenuti come originale - non modificati)
            # ... (resto della pagina Vendite identico alla v41.2 originale)
...
# ==========================================================================
    ...
    # ... (codice Promo identico alla v41.2 originale, senza modifiche richieste)
